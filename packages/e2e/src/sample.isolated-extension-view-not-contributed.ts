...
export const name = 'sample.isolated-extension-view-not-contributed'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'view sample.views.notContributed is registered but not contributed in extension.json')
}
