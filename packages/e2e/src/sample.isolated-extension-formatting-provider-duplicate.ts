...
export const name = 'sample.isolated-extension-formatting-provider-duplicate'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'formatting provider isolatedFormattingDuplicate is already registered')
}
