...
export const name = 'sample.isolated-extension-diagnostic-provider-duplicate'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'diagnostic provider isolatedDiagnosticDuplicate is already registered')
}
