...
export const name = 'sample.isolated-extension-hover-provider-invalid-result'
...
export const test: Test = async ({ Command, Extension }) => {
  ...
  await expectCommandToThrow(Command, 'invalid hover result: hover must be of type object or undefined but is "invalid hover"')
}
