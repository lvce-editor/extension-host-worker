...
export const name = 'sample.isolated-extension-hover-provider-duplicate'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'hover provider isolatedHoverDuplicate is already registered')
}
