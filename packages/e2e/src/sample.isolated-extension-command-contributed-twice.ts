...
export const name = 'sample.isolated-extension-command-contributed-twice'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'command isolatedDuplicate.run is contributed multiple times')
}
