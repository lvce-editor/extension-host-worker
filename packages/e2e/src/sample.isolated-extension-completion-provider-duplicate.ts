...
export const name = 'sample.isolated-extension-completion-provider-duplicate'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'completion provider isolatedCompletionDuplicate is already registered')
}
