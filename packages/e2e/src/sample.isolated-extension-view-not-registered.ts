...
export const name = 'sample.isolated-extension-view-not-registered'
...
export const test: Test = async ({ Extension }) => {
  ...
  await expectAddWebExtensionToThrow(Extension, uri, 'view sample.views.notRegistered is contributed in extension.json but not registered')
}
