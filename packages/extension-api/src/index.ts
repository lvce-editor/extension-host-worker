...
export { registerStatusBarItemProvider } from './parts/StatusBar/StatusBar.ts'
...
export type { StatusBarItem, StatusBarItemProvider, StatusBarItemProviderHandle } from './parts/StatusBar/StatusBar.ts'
